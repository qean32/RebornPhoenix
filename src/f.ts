...
export const f_post: postDto[] = [
    {
        ...
        "likes": 12,
        "content": "Анализ роста и изменений в сообществе любителей Dungeons & Dragons. Анализ роста и изменений в сообществе любителей Dungeons & Dragons. Анализ роста и изменений в сообществе любителей Dungeons & Dragons.",
    ...
    },
    {
        ...
        "content": "Советы новичкам, которые хотят окунуться в мир настольных ролевых игр.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Полезные рекомендации по созданию уникальных героев для вашей кампании.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Обзор последних обновлений и дополнений к любимой игре.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Рассказываем о местах, где можно поиграть в D&D офлайн и онлайн.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Подборка захватывающих сюжетов для вашего следующего приключения.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Особенности российского подхода к проведению кампаний в D&D.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Узнайте больше о нестандартных расах и классах в популярной ролевой игре.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Преимущества активного участия игроков в игровом процессе.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Краткий экскурс в историю самой известной ролевой игры мира.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Как победить грозных драконов в ваших приключениях.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Практические советы для мастеров игры по организации захватывающих боев.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Можно ли совмещать правила разных изданий в одной игровой сессии?",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Как адаптируются старые сценарии под современное поколение игроков.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Разбираем основные способы взаимодействия персонажей друг с другом.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Игроки рассказывают забавные случаи из реальных игр.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Процесс разработки новых фэнтезийных вселенных для D&D.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Простые шаги для рисования увлекательных карт в стиле D&D.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Полезные вещи, которые сделают ваши игровые вечера комфортнее.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Как дополнительные задания обогащают игру и развивают персонажей.",
        "likes": 52,
    ...
    },
    {
        ...
        "content": "Основы магии и грамотное применение магических способностей.",
        "likes": 52,
...
export const f_object: Omit<objectDto, 'id'>[] = [
    {
        status: '',
        name: 'Ящик с гоблином внутри',
        size: 2,
        path: '/img/f/object1.png',
