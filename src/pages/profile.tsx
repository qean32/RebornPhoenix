...
export const Profile = () => {
    ...
    const { id } = useParams()
    const [user, loading] = useRequest<Omit<userInterface, 'email'>>(() => profileService.GET_USER_INFO(id ?? 0), RQKEYFACTORY.profileInfo(id ?? 0))
    const [sub] = useRequest(() => profileService.GET_SUBSCRIBE(Number(id)), RQKEYFACTORY.mySubscribe())
