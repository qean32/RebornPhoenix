...
const MainSideForum: React.FC<{}> = ({ }: {}) => {
    ...
    const [post] = useRequest<postType>(() => forumService.GET_FIXED_POST(departmentId ?? 0), RQKEYFACTORY.fixed(departmentId ?? 0))
            ...
            <React.Suspense fallback={<DepartmentSceleton />}>
                <DynamicPagination
                    rq={{
                        ...
                        RQKey: [...RQKEYFACTORY.posts(departmentId ?? 0), Math.random().toString()],
